...
export function AboutMe() {
	return (
		<div
			...
			id="2"
		>
			<div className="md:max-w-[70%] w-[75%]">
				<div className="flex justify-between gap-x-10">
					<div className="w-[250px] h-[250px] md:w-[1100px] md:h-[500px] rounded-lg overflow-hidden relative md:shadow-[12px_12px_30px_-15px_hsl(var(--red-primary)/_0.2)] hidden md:block">
						<img
							src="/perfil-2.webp"
							alt="Me in a car!"
					...
					<div className="md:ml-10">
						<h2 className="md:text-5xl text-4xl uppercase font-bold mb-10 md:mt-0">
							About Me
						</h2>
						...
						<p className="mt-5 md:text-lg leading-relaxed text-sm">
						...
						<div className="flex items-start justify-start gap-x-4 mt-14">
							<a
